 ...
 */
async function generateAndSaveReport(serverUrl = null) {
  try {
    ...
    // Use current origin if serverUrl not provided (works in both dev and production)
    const apiUrl = serverUrl || window.location.origin;
